...
\begin{figure}[htbp]
    ...
    \caption{CUSUM results for the basic method (left) and the CUSUM with reset (right). The signal has a fault starting at $k = 5,000$ and ending at $k = 10,000$.}
    \label{fig:CUSUM}
\end{figure}
