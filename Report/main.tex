...
Fig. \ref{fig:isolation} shows a fault applied on different sensors and the corresponding residuals. Looking at the ones that are activated and combining it with the knowledge of the confusion matrix shows it is working as intended.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.48\textwidth]{../Matlab/ParityMethods/Isolation.png}
    \caption{Applied fault (top) and resulting residual (bottom).}
    \label{fig:isolation}
\end{figure}
