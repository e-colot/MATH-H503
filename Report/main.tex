...
\begin{figure}[htbp]
    ...
    \caption{Applied fault (on state 1 on the left plot and state 2 on the right plot) and resulting residual. The second fault looks like a step due to the scale difference between the parity vector norm and the fault signal itself.}
